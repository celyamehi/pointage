        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 mb-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-500">Fichier APK • ~28 MB • v2.0.5</p>
            </div>

            <a
              href="https://github.com/celyamehi/pointage/releases/download/v2.0.5/pointage-collable-v2.0.5.apk"
              download="pointage-collable-v2.0.5.apk"
